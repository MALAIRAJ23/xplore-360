...
const modules = [
  {
    ...
    description: 'Efficiently manage the entire student admission journey from enquiry to enrollment.',
    features: ['Capture and Manage Leads', 'Follow-up Tracking', 'Admission Process Management'],
    image: admissionsImg,
    accent: '#635BFF'
  },
  {
    ...
    description: 'Organize and manage every student\'s journey from enrollment to course completion.',
    features: ['Centralized Student Database ', 'Batch & Course Allocation ', 'Day-wise Syllabus Tracking'],
    image: studentImg,
    accent: '#059669'
  },
  {
    ...
    description: 'Gain complete visibility into your institute\'s finances with centralized tracking of enrollments, fee collections, income, expenses, and outstanding dues.',
    features: ['Income & Expense Tracking', 'Outstanding Due Tracking', 'Receipt Generation'],
    image: feeImg,
    accent: '#EA580C'
  },
  {
    ...
    description: 'Track and manage student and staff attendance with ease through biometric, manual, or app-based check-ins.',
    features: ['Student & Staff Attendance', 'Automated Attendance Alerts', 'Real-Time Attendance Reports'],
    image: attendanceImg,
    accent: '#9333EA'
  },
  {
    ...
    description: 'Manage employee records, responsibilities, and performance efficiently.',
    features: ['Staff Profiles', 'Top Performers Data', 'Role Based Access'],
    image: staffImg,
    accent: '#D97706'
  },
  {
    ...
    description: 'Transform institutional data into actionable insights to support informed decision-making.',
    features: ['Custom Reports & Dashboards', 'Real-Time Data Monitoring', 'Trend Analysis & Forecasting'],
    image: reportsImg,
    accent: '#4F46E5'
  },
];
